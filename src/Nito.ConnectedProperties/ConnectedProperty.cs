...
namespace Nito.ConnectedProperties
{
    ...
    public sealed class ConnectedProperty
    {
        ...
        public static ConnectedProperty GetConnectedProperty(object carrier, string name, bool bypassValidation = false) =>
            ConnectedPropertyScope.Default.GetConnectedProperty(carrier, name, bypassValidation);
        ...
        public static void CopyAll(object fromCarrier, object toCarrier) => ConnectedPropertyScope.Default.CopyAll(fromCarrier, toCarrier);
        ...
        public bool TryGet(out object value) => _dictionary.TryGetValue(_key, out value);
        ...
        public bool TryConnect(object value) => _dictionary.TryAdd(_key, value);
        ...
        public bool TryUpdate(object newValue, object comparisonValue) => _dictionary.TryUpdate(_key, newValue, comparisonValue);
        ...
        public dynamic GetOrCreate(Func<object> createCallback) => _dictionary.GetOrAdd(_key, _ => createCallback());
        ...
        public dynamic CreateOrUpdate(Func<object> createCallback, Func<dynamic, object> updateCallback) =>
            _dictionary.AddOrUpdate(_key, _ => createCallback(), (_, oldValue) => updateCallback(oldValue));
        ...
        /// <returns>The value of the property.</returns>
        public dynamic GetOrConnect(object connectValue) => GetOrCreate(() => connectValue);
        ...
        /// <param name="updateCallback">The delegate invoked to update the value if the property is connected.</param>
        public dynamic ConnectOrUpdate(object connectValue, Func<dynamic, object> updateCallback) => CreateOrUpdate(() => connectValue, updateCallback);

        /// <summary>
        /// Sets the value of the property, overwriting any existing value.
        /// </summary>
        /// <param name="value">The value to set.</param>
        public void Set(object value) => CreateOrUpdate(() => value, _ => value);
